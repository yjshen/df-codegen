...
use crate::{all_valid, fn_name, get_offsets, reg_fn, supported, NullBitsFormatter};
use arrow::array::*;
...
fn get_array_mut(batch: &mut MutableRecordBatch, col_idx: usize) -> &mut Box<dyn ArrayBuilder> {
